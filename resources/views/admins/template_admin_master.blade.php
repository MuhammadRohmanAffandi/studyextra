...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="/adminargon/assets/img/logo.png">
  <link rel="icon" type="image/png" href="/adminargon/assets/img/logo.png">
  <title>
    Admin LBB Study Extra
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-6  fixed-start ms-4 ps" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href="admin">
        <img src="/adminargon/assets/img/logo.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Admin LBB Study Extra</span>
      </a>
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Admin Pendaftaran</h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Admin Alumni</h6>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Admin Siswa</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-siswa-tk">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-danger text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Siswa TK</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-siswa-sd">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-primary text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Siswa SD</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-siswa-smp">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Siswa SMP</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-siswa-sma">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-warning text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Siswa SMA</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-siswa-unggulan">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-single-02 text-success text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Siswa Unggulan</span>
          </a>
        </li>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Admin Perpustakaan</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-ebook">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Admin Kritik dan Saran</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="admin-kritik-saran">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="collapse navbar-collapse w-auto ps ps--active-y" id="sidenav-collapse-main">
      <div class="ps__rail-x" style="left: 0px; bottom: -88px;">
        <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
      </div>
      <div class="ps__rail-y" style="top: 88px; height: 386px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 70px; height: 307px;"></div>
      </div>
    </div>
          ...
          <ul class="navbar-nav  justify-content-end">
            <ul class="nav navbar-nav">
              ...
              <div class="navbar-nav  justify-content-end">
                <div class="nav-link" href="" style="color: white;">
                  {{ Auth::user()->name }}
                </div>
              </div>
              @endguest
