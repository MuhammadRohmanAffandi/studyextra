        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-header d-flex">
                    <form action="/admin-alumni" method="GET">
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Completion</th> -->
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th></th>
                                    <th>
                                        <span class="text-xs font-weight-bold"><a href="{{ asset('img/alumni/'. $item->foto_siswa) }}" target="_blank" rel="noopener noreferrer">Lihat Gambar</a></span>
                                    </th>
                                    <th></th>
                                    <th>
                                    ...
                                    <th class="align-middle">
                                        <a class="btn btn-link text-danger text-gradient px-0 mb-0" href="{{ url('admin-delete-alumni', $item->id)}}"><i class="far fa-trash-alt me-2" aria-hidden="true"></i></a>
                                        <a class="btn btn-link text-info text-gradient px-0 mb-0" href="{{ url('admin-edit-alumni', $item->id)}}"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i></a>
                                        </a>
                                    </th>
                                    <th></th>
                                </tr>
                ...
                <div class="card-header pb-0">
                    <div class="tm-table-mt tm-table-actions-row">
                        <div class="box-footer">
                            {{-- <div class="box-body"> --}}
                            {!! $tambahalumnis->appends(Request::except('page'))->render() !!}
                        </div>
                    </div>
                </div>
            </div>
